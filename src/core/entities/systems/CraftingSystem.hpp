...
#include "../../world/contexts/CraftingContext.hpp"
...
public:
    void update(float deltaTime, CraftingContext& context, const RecipeDatabase& recipeDatabase, const ItemDatabase& itemDatabase, const FluidDatabase& fluidDatabase);

private:
    bool syncRecipeInventoryLayout(MachineInventoryComponent& inventory, const RecipeDefinition& recipe);
    void processMachine(float deltaTime, CraftingMachineComponent& machine, MachineInventoryComponent& inventory, MachineFluidComponent* machineFluid, const RecipeDefinition& recipe, const ItemDatabase& itemDatabase, const FluidDatabase& fluidDatabase);
