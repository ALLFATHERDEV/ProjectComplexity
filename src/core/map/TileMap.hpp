...
public:
    ...
    void setTile(int x, int y, const Sprite &sprite, int layer, const std::string& paletteName, int atlasX, int atlasY, bool isBlocking = false, const TileAnimationDatabase* tileAnimationDatabase = nullptr);
